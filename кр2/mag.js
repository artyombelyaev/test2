async function getResponce() {
    ...
    for (key in content) {
        ...
        <li style="width: 210px" class="d-flex flex-column m-1 p-1 border  bg-warning">
        <img style="width: 180px" class="align-self-center" src=${content[key].img}>
        <h5 class="card-title">${content[key].title}</h5>
        <p class="card-text  bg-warning">${content[key].description}. Цена ${content[key].price} р.</p>
